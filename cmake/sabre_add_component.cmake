...
function(sabre_add_executable exe_name)
  ...
  add_dependencies(${exe_name} jemalloc)
  target_link_libraries(${exe_name} loader ${JEMALLOC_STATIC_LIB})
endfunction()
...
function(sabre_add_plugin plugin_name)
  ...
  add_dependencies(${plugin_name} jemalloc)
  target_link_libraries(${plugin_name} realsyscall ${JEMALLOC_STATIC_LIB})
endfunction()
